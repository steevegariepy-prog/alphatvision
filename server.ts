...
async function startServer() {
  ...
  app.post("/api/process-image", async (req, res) => {
    ...
    const finishPrompt = isGlossy
      ? "Modify this image to show a freshly sealed asphalt driveway. Keep any public street, public road, sidewalk, or neighboring asphalt completely untouched and in its original state; only transform the private driveway area. The private driveway's asphalt should be transformed into a uniform, rich, deep glossy black color with a beautiful shiny wet-look sheen, reflecting subtle lighting highlights, as if premium asphalt sealer was freshly poured. Remove all cracks, stains, and graying from the driveway asphalt. CRITICAL: Ensure the rest of the image (including people, animals, objects on the driveway, house, grass, cars, sky, walls, public street) remains completely unchanged and exactly as they are in the original image. Keep any person standing on the driveway perfectly intact without any modifications to them. The transition between the new driveway and the surroundings must be seamless. Return only the modified image."
      : "Modify this image to show a freshly sealed asphalt driveway. Keep any public street, public road, sidewalk, or neighboring asphalt completely untouched and in its original state; only transform the private driveway area. The private driveway's asphalt should be transformed into a uniform, deep matte black color with a subtle granular texture. Remove all cracks, stains, and graying from the driveway asphalt. CRITICAL: Ensure the rest of the image (including people, animals, objects on the driveway, house, grass, cars, sky, walls, public street) remains completely unchanged and exactly as they are in the original image. Keep any person standing on the driveway perfectly intact without any modifications to them. The transition between the new driveway and the surroundings must be seamless. Return only the modified image.";
